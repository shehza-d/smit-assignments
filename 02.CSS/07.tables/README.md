...
![video of end result of this task](./task7.png)
...
- Give appropriate border and padding to td.

- Style the table header cells with a different background color and font color.

- Add a margin and padding to the header for spacing.

- Set a unique background color to every even row in the table.

- Apply a custom font family to the header.

- Adjust the line height of the list items.

- Add a subtle box shadow to the product comparison section.

- Give margin of 30px and padding of 10px to product comparison section.

- Add a border and padding to the unordered list items.
